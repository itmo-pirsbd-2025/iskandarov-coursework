...
Данный проект — учебный прототип системы крипто-аналитики, реализуемый в рамках дисциплины **"Потоковый анализ данных"** и дисциплины **"JAVA для высоконагруженных вычислений"**???
